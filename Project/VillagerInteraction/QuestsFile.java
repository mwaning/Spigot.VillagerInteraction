...
public class QuestsFile {
	...
	public QuestsFile(VillagerInteraction plugin) {
		this.plugin = plugin;
		saveDefault();
	}
	...
	public static void reload() {
		if (file == null) {
			file = new File(Bukkit.getServer().getPluginManager().getPlugin("VillagerInteraction").getDataFolder(), "quests.yml");
		}
		
		config = YamlConfiguration.loadConfiguration(file);
		
		InputStream defaultStream = (Bukkit.getServer().getPluginManager().getPlugin("VillagerInteraction").getResource("quests.yml"));
